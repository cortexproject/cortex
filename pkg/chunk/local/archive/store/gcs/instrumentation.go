...
var (
	gcsArchiveRequestDuration = promauto.NewHistogramVec(prometheus.HistogramOpts{
		Namespace: "cortex",
		Name:      "gcs_archive_request_duration_seconds",
...
func gcsInstrumentation(ctx context.Context, scope string) (option.ClientOption, error) {
	...
	client := &http.Client{
		Transport: instrumentedTransport{
			observer: gcsArchiveRequestDuration,
			next:     transport,
		},
	}
