	...
	tests := map[string]struct {
		...
		"input blocks can be compacted on the 1st range only": {
			...
			blocks: []*metadata.Meta{
				{MinTime: 10, MaxTime: 20},
				{MinTime: 20, MaxTime: 30},
				{MinTime: 25, MaxTime: 30},
				{MinTime: 30, MaxTime: 40},
				{MinTime: 40, MaxTime: 50},
				{MinTime: 50, MaxTime: 60},
				{MinTime: 60, MaxTime: 70},
			},
			expected: []blocksGroup{
		...
		"input blocks have already been compacted with the largest range": {
			...
			blocks: []*metadata.Meta{
				...
				{MinTime: 40, MaxTime: 70},
				{MinTime: 80, MaxTime: 120},
			},
			expected: nil,
		},
		...
		"a block with time range crossing two 1st level ranges should be NOT considered for 1st level compaction": {
			...
			blocks: []*metadata.Meta{
				{MinTime: 10, MaxTime: 20},
				{MinTime: 10, MaxTime: 30}, // This block spans across two 1st level ranges.
				{MinTime: 20, MaxTime: 30},
				{MinTime: 30, MaxTime: 40},
			},
			expected: []blocksGroup{
		...
		"a block with time range larger then the largest compaction range should NOT be considered for compaction": {
			...
			blocks: []*metadata.Meta{
				{MinTime: 0, MaxTime: 40},
				{MinTime: 30, MaxTime: 150}, // This block is larger then the largest compaction range.
				{MinTime: 40, MaxTime: 70},
				{MinTime: 80, MaxTime: 120},
				{MinTime: 80, MaxTime: 120},
			},
