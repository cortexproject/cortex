...
func InitLogger(cfg *server.Config) {
	...
	// when use util.Logger, depth of callstack is 3
	Logger = log.With(l, "caller", log.Caller(3))

	// when use cfg.Log, depth of callstack will be 5 because
	// a. it wraps log function
	// b. logging.gokit's methods are declared with value receiver,
	//    an autogenerated function is involved when indirect call on interface
