...
func NewAlertingRule(
	...
	restored bool, logger log.Logger, srcTenants, destTenant string,
) *AlertingRule {
...
func (r *AlertingRule) GetDestTenant() string {
	return r.destTenant
}

func (r *AlertingRule) GetSrcTenants() string {
	return r.srcTenants
}
...
func (r *AlertingRule) String() string {
	ar := rulefmt.Rule{
		...
		SrcTenants:  r.srcTenants,
		DestTenant:  r.destTenant,
	}
