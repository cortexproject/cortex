...
func (m *ReloadRulesRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ReloadRulesRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ReloadRulesRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ReloadRulesRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ReloadRulesRequest.Merge(m, src)
}
func (m *ReloadRulesRequest) XXX_Size() int {
	return m.Size()
}
func (m *ReloadRulesRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_ReloadRulesRequest.DiscardUnknown(m)
}

var xxx_messageInfo_ReloadRulesRequest proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*ReloadRulesRequest)(nil), "ruler.ReloadRulesRequest")
...
var fileDescriptor_9ecbec0a4cfddea6 = []byte{
	...
	,
}
...
func (this *ReloadRulesRequest) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ReloadRulesRequest)
	if !ok {
		that2, ok := that.(ReloadRulesRequest)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *ReloadRulesRequest) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 4)
	s = append(s, "&ruler.ReloadRulesRequest{")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
type RulerClient interface {
	...
	ReloadRules(ctx context.Context, in *ReloadRulesRequest, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *rulerClient) ReloadRules(ctx context.Context, in *ReloadRulesRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/ruler.Ruler/ReloadRules", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RulerServer interface {
	...
	ReloadRules(context.Context, *ReloadRulesRequest) (*empty.Empty, error)
}
...
func (*UnimplementedRulerServer) ReloadRules(ctx context.Context, req *ReloadRulesRequest) (*empty.Empty, error) {
...
func _Ruler_ReloadRules_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReloadRulesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RulerServer).ReloadRules(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ruler.Ruler/ReloadRules",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RulerServer).ReloadRules(ctx, req.(*ReloadRulesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Ruler_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Ruler_ReloadRules_Handler,
		},
	},
...
func (m *ReloadRulesRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ReloadRulesRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ReloadRulesRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ReloadRulesRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *ReloadRulesRequest) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ReloadRulesRequest{`,
		`}`,
	}, "")
	return s
}
...
func (m *ReloadRulesRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
