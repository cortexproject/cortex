...
type RuleGroupDesc struct {
	...
	// Tenants whose data is queried when evaluating this group. Empty means the
	// owning tenant only. Non-empty makes this a federated rule group.
	SrcTenants []string `protobuf:"bytes,13,rep,name=src_tenants,json=srcTenants,proto3" json:"src_tenants,omitempty"`
}
...
func (m *RuleGroupDesc) GetSrcTenants() []string {
	if m != nil {
		return m.SrcTenants
	}
	return nil
...
var fileDescriptor_8e722d3e922f0937 = []byte{
	...
	,
}
...
func (this *RuleGroupDesc) Equal(that interface{}) bool {
	...
	if len(this.SrcTenants) != len(that1.SrcTenants) {
		return false
	}
	for i := range this.SrcTenants {
		if this.SrcTenants[i] != that1.SrcTenants[i] {
			return false
		}
	}
	return true
...
func (m *RuleGroupDesc) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.SrcTenants) > 0 {
		for iNdEx := len(m.SrcTenants) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.SrcTenants[iNdEx])
			copy(dAtA[i:], m.SrcTenants[iNdEx])
			i = encodeVarintRules(dAtA, i, uint64(len(m.SrcTenants[iNdEx])))
			i--
			dAtA[i] = 0x6a
		}
	}
...
func (this *RuleGroupDesc) String() string {
	...
	s := strings.Join([]string{`&RuleGroupDesc{`,
		...
		`SrcTenants:` + fmt.Sprintf("%v", this.SrcTenants) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *RuleGroupDesc) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 13:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SrcTenants", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SrcTenants = append(m.SrcTenants, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
