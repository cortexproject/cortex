...
func (l *Limits) RegisterFlags(f *flag.FlagSet) {
	...
	f.IntVar(&l.MaxMetadataLength, "validation.max-length-metadata", 1024, "Maximum length accepted for metric metadata. Metadata refers to Metric Name, HELP and UNIT.")
