...
ha_tracker:
  ...
  # Backend storage to use for the ring. Please be aware that memberlist support
  # in the HA tracker is currently experimental since gossip propagation is too
