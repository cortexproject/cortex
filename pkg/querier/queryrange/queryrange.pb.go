...
type PrometheusRequest struct {
	...
	CacheDirectives CacheDirectives `protobuf:"bytes,7,opt,name=cacheDirectives,proto3" json:"cacheDirectives"`
}
...
func (m *PrometheusRequest) GetCacheDirectives() CacheDirectives {
	if m != nil {
		return m.CacheDirectives
	}
...
func (m *CacheDirectives) Reset()      { *m = CacheDirectives{} }
func (*CacheDirectives) ProtoMessage() {}
func (*CacheDirectives) Descriptor() ([]byte, []int) {
	return fileDescriptor_79b02382e213d0b2, []int{7}
}
func (m *CacheDirectives) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CacheDirectives) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CacheDirectives.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CacheDirectives) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CacheDirectives.Merge(m, src)
}
func (m *CacheDirectives) XXX_Size() int {
	return m.Size()
}
func (m *CacheDirectives) XXX_DiscardUnknown() {
	xxx_messageInfo_CacheDirectives.DiscardUnknown(m)
}

var xxx_messageInfo_CacheDirectives proto.InternalMessageInfo

func (m *CacheDirectives) GetDisabled() bool {
	if m != nil {
		return m.Disabled
	}
	return false
...
func init() {
	...
	proto.RegisterType((*CacheDirectives)(nil), "queryrange.CacheDirectives")
}
...
var fileDescriptor_79b02382e213d0b2 = []byte{
	...
	,
}
...
func (this *PrometheusRequest) Equal(that interface{}) bool {
	...
	if !this.CacheDirectives.Equal(&that1.CacheDirectives) {
		return false
	}
	return true
}
...
func (this *CacheDirectives) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*CacheDirectives)
	if !ok {
		that2, ok := that.(CacheDirectives)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *PrometheusRequest) GoString() string {
	...
	s = append(s, "CacheDirectives: "+strings.Replace(this.CacheDirectives.GoString(), `&`, ``, 1)+",\n")
	s = append(s, "}")
...
func (this *CacheDirectives) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&queryrange.CacheDirectives{")
...
func (m *PrometheusRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size, err := m.CacheDirectives.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *CacheDirectives) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CacheDirectives) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CacheDirectives) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *CacheDirectives) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *PrometheusRequest) String() string {
	...
	s := strings.Join([]string{`&PrometheusRequest{`,
		...
		`CacheDirectives:` + strings.Replace(strings.Replace(this.CacheDirectives.String(), "CacheDirectives", "CacheDirectives", 1), `&`, ``, 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *CacheDirectives) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CacheDirectives{`,
...
func (m *PrometheusRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CacheDirectives", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.CacheDirectives.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *CacheDirectives) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CacheDirectives: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CacheDirectives: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
