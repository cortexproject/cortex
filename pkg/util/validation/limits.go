...
type QueryAttribute struct {
	...
	QueryStepLimit         QueryStepLimit `yaml:"query_step_limit" json:"query_step_limit" doc:"nocli|description=If query step provided should be within this limit to match. If query contains subquery and it has steps provided, then it will be checked as well. If not set, it won't be checked. This property won't be applied to metadata queries."`
