...
* [CHANGE] Available flags are printed to stdout, and only when requested via `-help`. Using invalid flags no longer causes printing of all available flags. #2691
