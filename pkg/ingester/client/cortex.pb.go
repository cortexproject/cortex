...
import (
	...
	fmt "fmt"
	ring "github.com/cortexproject/cortex/pkg/ring"
...
type GetChunksRequest struct {
	FromIngesterId string            `protobuf:"bytes,1,opt,name=from_ingester_id,json=fromIngesterId,proto3" json:"from_ingester_id,omitempty"`
	Ranges         []ring.TokenRange `protobuf:"bytes,2,rep,name=ranges,proto3" json:"ranges"`
...
func (m *GetChunksRequest) GetRanges() []ring.TokenRange {
	if m != nil {
		return m.Ranges
	}
	return nil
...
type UnblockRangesRequest struct {
	Ranges []ring.TokenRange `protobuf:"bytes,2,rep,name=ranges,proto3" json:"ranges"`
}

func (m *UnblockRangesRequest) Reset()      { *m = UnblockRangesRequest{} }
func (*UnblockRangesRequest) ProtoMessage() {}
func (*UnblockRangesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_893a47d0a749d749, []int{22}
}
func (m *UnblockRangesRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *UnblockRangesRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_UnblockRangesRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (m *UnblockRangesRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UnblockRangesRequest.Merge(m, src)
}
func (m *UnblockRangesRequest) XXX_Size() int {
	return m.Size()
}
func (m *UnblockRangesRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_UnblockRangesRequest.DiscardUnknown(m)
}

var xxx_messageInfo_UnblockRangesRequest proto.InternalMessageInfo

func (m *UnblockRangesRequest) GetRanges() []ring.TokenRange {
	if m != nil {
		return m.Ranges
	}
	return nil
...
type UnblockRangesResponse struct {
}

func (m *UnblockRangesResponse) Reset()      { *m = UnblockRangesResponse{} }
func (*UnblockRangesResponse) ProtoMessage() {}
func (*UnblockRangesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_893a47d0a749d749, []int{23}
}
func (m *UnblockRangesResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *UnblockRangesResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_UnblockRangesResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (m *UnblockRangesResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UnblockRangesResponse.Merge(m, src)
}
func (m *UnblockRangesResponse) XXX_Size() int {
	return m.Size()
}
func (m *UnblockRangesResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_UnblockRangesResponse.DiscardUnknown(m)
}

var xxx_messageInfo_UnblockRangesResponse proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*UnblockRangesRequest)(nil), "cortex.UnblockRangesRequest")
	proto.RegisterType((*UnblockRangesResponse)(nil), "cortex.UnblockRangesResponse")
...
var fileDescriptor_893a47d0a749d749 = []byte{
	...
	,
}
...
func (this *UnblockRangesRequest) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*UnblockRangesRequest)
	if !ok {
		that2, ok := that.(UnblockRangesRequest)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *UnblockRangesResponse) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*UnblockRangesResponse)
	if !ok {
		that2, ok := that.(UnblockRangesResponse)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *GetChunksRequest) GoString() string {
	...
	s = append(s, "FromIngesterId: "+fmt.Sprintf("%#v", this.FromIngesterId)+",\n")
	if this.Ranges != nil {
		vs := make([]*ring.TokenRange, len(this.Ranges))
		for i := range vs {
			vs[i] = &this.Ranges[i]
		}
...
func (this *UnblockRangesRequest) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&client.UnblockRangesRequest{")
	if this.Ranges != nil {
		vs := make([]*ring.TokenRange, len(this.Ranges))
		for i := range vs {
			vs[i] = &this.Ranges[i]
...
func (this *UnblockRangesResponse) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 4)
	s = append(s, "&client.UnblockRangesResponse{")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
type IngesterClient interface {
	...
	TransferChunksSubset(ctx context.Context, opts ...grpc.CallOption) (Ingester_TransferChunksSubsetClient, error)
	...
	GetChunksSubset(ctx context.Context, in *GetChunksRequest, opts ...grpc.CallOption) (Ingester_GetChunksSubsetClient, error)
	...
	UnblockRanges(ctx context.Context, in *UnblockRangesRequest, opts ...grpc.CallOption) (*UnblockRangesResponse, error)
}
...
func (c *ingesterClient) TransferChunksSubset(ctx context.Context, opts ...grpc.CallOption) (Ingester_TransferChunksSubsetClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Ingester_serviceDesc.Streams[3], "/cortex.Ingester/TransferChunksSubset", opts...)
	if err != nil {
		return nil, err
	}
	x := &ingesterTransferChunksSubsetClient{stream}
	return x, nil
}

type Ingester_TransferChunksSubsetClient interface {
	Send(*TimeSeriesChunk) error
	CloseAndRecv() (*TransferChunksResponse, error)
	grpc.ClientStream
}

type ingesterTransferChunksSubsetClient struct {
	grpc.ClientStream
}

func (x *ingesterTransferChunksSubsetClient) Send(m *TimeSeriesChunk) error {
	return x.ClientStream.SendMsg(m)
}

func (x *ingesterTransferChunksSubsetClient) CloseAndRecv() (*TransferChunksResponse, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(TransferChunksResponse)
...
func (c *ingesterClient) GetChunksSubset(ctx context.Context, in *GetChunksRequest, opts ...grpc.CallOption) (Ingester_GetChunksSubsetClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Ingester_serviceDesc.Streams[4], "/cortex.Ingester/GetChunksSubset", opts...)
	if err != nil {
		return nil, err
	}
	x := &ingesterGetChunksSubsetClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type Ingester_GetChunksSubsetClient interface {
	Recv() (*TimeSeriesChunk, error)
	grpc.ClientStream
}

type ingesterGetChunksSubsetClient struct {
	grpc.ClientStream
}

func (x *ingesterGetChunksSubsetClient) Recv() (*TimeSeriesChunk, error) {
...
func (c *ingesterClient) UnblockRanges(ctx context.Context, in *UnblockRangesRequest, opts ...grpc.CallOption) (*UnblockRangesResponse, error) {
	out := new(UnblockRangesResponse)
	err := c.cc.Invoke(ctx, "/cortex.Ingester/UnblockRanges", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type IngesterServer interface {
	...
	// TransferChunksSubset is invoked by a leaving ingester (client), streaming
	// a subset of its chunks directly to an existing ingester.
	TransferChunksSubset(Ingester_TransferChunksSubsetServer) error
	// GetChunksSubset is invoked by a joining ingester (client). A subset of the
	// serving ingester's chunks will be sent as a stream.
	GetChunksSubset(*GetChunksRequest, Ingester_GetChunksSubsetServer) error
	// UnblockRanges is invoked by a joining ingester after it has successfully
	// joined the ring. When invoked, it is safe to forcefully remove blocked
	// ranges without waiting for them to time out.
	UnblockRanges(context.Context, *UnblockRangesRequest) (*UnblockRangesResponse, error)
}
...
func _Ingester_TransferChunksSubset_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(IngesterServer).TransferChunksSubset(&ingesterTransferChunksSubsetServer{stream})
}

type Ingester_TransferChunksSubsetServer interface {
	SendAndClose(*TransferChunksResponse) error
	Recv() (*TimeSeriesChunk, error)
	grpc.ServerStream
}

type ingesterTransferChunksSubsetServer struct {
	grpc.ServerStream
}

func (x *ingesterTransferChunksSubsetServer) SendAndClose(m *TransferChunksResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *ingesterTransferChunksSubsetServer) Recv() (*TimeSeriesChunk, error) {
	m := new(TimeSeriesChunk)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func _Ingester_GetChunksSubset_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(GetChunksRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(IngesterServer).GetChunksSubset(m, &ingesterGetChunksSubsetServer{stream})
}

type Ingester_GetChunksSubsetServer interface {
	Send(*TimeSeriesChunk) error
	grpc.ServerStream
}

type ingesterGetChunksSubsetServer struct {
	grpc.ServerStream
}

func (x *ingesterGetChunksSubsetServer) Send(m *TimeSeriesChunk) error {
	return x.ServerStream.SendMsg(m)
}

func _Ingester_UnblockRanges_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UnblockRangesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(IngesterServer).UnblockRanges(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cortex.Ingester/UnblockRanges",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IngesterServer).UnblockRanges(ctx, req.(*UnblockRangesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Ingester_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UnblockRanges",
			Handler:    _Ingester_UnblockRanges_Handler,
		},
	},
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "TransferChunksSubset",
			Handler:       _Ingester_TransferChunksSubset_Handler,
			ClientStreams: true,
		},
		{
			StreamName:    "GetChunksSubset",
			Handler:       _Ingester_GetChunksSubset_Handler,
			ServerStreams: true,
		},
	},
...
func (m *UnblockRangesRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *UnblockRangesRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *UnblockRangesResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *UnblockRangesResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *UnblockRangesRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *UnblockRangesResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *GetChunksRequest) String() string {
	...
	s := strings.Join([]string{`&GetChunksRequest{`,
		`FromIngesterId:` + fmt.Sprintf("%v", this.FromIngesterId) + `,`,
		`Ranges:` + strings.Replace(strings.Replace(fmt.Sprintf("%v", this.Ranges), "TokenRange", "ring.TokenRange", 1), `&`, ``, 1) + `,`,
		`Move:` + fmt.Sprintf("%v", this.Move) + `,`,
		`}`,
	}, "")
	return s
}
func (this *UnblockRangesRequest) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&UnblockRangesRequest{`,
		`Ranges:` + strings.Replace(strings.Replace(fmt.Sprintf("%v", this.Ranges), "TokenRange", "ring.TokenRange", 1), `&`, ``, 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *UnblockRangesResponse) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&UnblockRangesResponse{`,
		`}`,
	}, "")
	return s
}
...
func (m *GetChunksRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Ranges = append(m.Ranges, ring.TokenRange{})
...
func (m *UnblockRangesRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: UnblockRangesRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: UnblockRangesRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 2:
			if wireType != 2 {
...
func (m *UnblockRangesResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: UnblockRangesResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: UnblockRangesResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
