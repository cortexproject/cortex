...
func (cfg *Config) RegisterFlags(f *flag.FlagSet) {
	...
	f.DurationVar(&cfg.HeadCompactionIdleTimeout, "experimental.tsdb.head-compaction-idle-timeout", 0, "If TSDB head is idle for this duration, it is compacted. 0 means disabled.")
