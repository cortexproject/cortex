...
type Rule struct {
	...
	DestTenant  string            `yaml:"dest_tenant,omitempty"`
}
...
type RuleNode struct {
	...
	Labels      map[string]string `yaml:"labels,omitempty"`
	Annotations map[string]string `yaml:"annotations,omitempty"`
	SrcTenants  yaml.Node         `yaml:"src_tenants,omitempty"`
	DestTenant  yaml.Node         `yaml:"dest_tenant,omitempty"`
}

func (r *RuleNode) IsFederated() bool {
	return r.SrcTenants.Value != "" || r.DestTenant.Value != ""
}
