...
func TestIngesterRollingUpdate(t *testing.T) {
	// test prometheus remote write 2.0 push, when -distributor.remote-write2-enabled is true and ingester use 1.18.1 image.
	// remote write 2.0 push success but, response header values are set to "0".
	const blockRangePeriod = 5 * time.Second
	ingesterImage := "quay.io/cortexproject/cortex:v1.18.1"
