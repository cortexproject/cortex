...
type RuleDesc struct {
	...
	SrcTenants  string                                                      `protobuf:"bytes,13,opt,name=src_tenants,json=srcTenants,proto3" json:"src_tenants,omitempty"`
	DestTenant  string                                                      `protobuf:"bytes,14,opt,name=dest_tenant,json=destTenant,proto3" json:"dest_tenant,omitempty"`
...
func (m *RuleDesc) GetSrcTenants() string {
	if m != nil {
		return m.SrcTenants
	}
	return ""
...
func (m *RuleDesc) GetDestTenant() string {
	if m != nil {
		return m.DestTenant
	}
	return ""
...
var fileDescriptor_8e722d3e922f0937 = []byte{
	...
	,
}
...
func (this *RuleDesc) Equal(that interface{}) bool {
	...
	if this.SrcTenants != that1.SrcTenants {
		return false
	}
	if this.DestTenant != that1.DestTenant {
		return false
	}
...
func (m *RuleDesc) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.DestTenant) > 0 {
		i -= len(m.DestTenant)
		copy(dAtA[i:], m.DestTenant)
		i = encodeVarintRules(dAtA, i, uint64(len(m.DestTenant)))
		i--
		dAtA[i] = 0x72
	}
	if len(m.SrcTenants) > 0 {
		i -= len(m.SrcTenants)
		copy(dAtA[i:], m.SrcTenants)
		i = encodeVarintRules(dAtA, i, uint64(len(m.SrcTenants)))
		i--
		dAtA[i] = 0x6a
	}
...
func (this *RuleDesc) String() string {
	...
	s := strings.Join([]string{`&RuleDesc{`,
		...
		`DestTenant:` + fmt.Sprintf("%v", this.DestTenant) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *RuleDesc) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 13:
			...
			m.SrcTenants = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 14:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DestTenant", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DestTenant = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipRules(dAtA[iNdEx:])
