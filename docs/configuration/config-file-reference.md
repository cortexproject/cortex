...
api:
  # Use compression for the Ruler and Alertmanager configuration API responses.
  # Some endpoints of these components serve large YAML or JSON blobs which can
  # benefit from compression.
  # CLI flag: -api.enable-response-compression
  [enable_response_compression: <boolean> | default = false]
