...
- `-querier.query-parallelism`
   ...
   This refers to database queries against the store when running the Cortex chunks storage (e.g. Bigtable or DynamoDB).  This is the max subqueries run in parallel per higher-level query.
