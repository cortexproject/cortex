...
func (m *Matchers) GetMatchers() []*LabelMatcher {
	if m != nil {
		return m.Matchers
	}
	return nil
...
type ExemplarQueryRequest struct {
	StartTimestampMs int64       `protobuf:"varint,1,opt,name=start_timestamp_ms,json=startTimestampMs,proto3" json:"start_timestamp_ms,omitempty"`
	EndTimestampMs   int64       `protobuf:"varint,2,opt,name=end_timestamp_ms,json=endTimestampMs,proto3" json:"end_timestamp_ms,omitempty"`
	Matchers         []*Matchers `protobuf:"bytes,3,rep,name=matchers,proto3" json:"matchers,omitempty"`
}
...
func (m *ExemplarQueryRequest) GetMatchers() []*Matchers {
	if m != nil {
		return m.Matchers
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*Matchers)(nil), "cortex.Matchers")
...
var fileDescriptor_60f6df4f3586b478 = []byte{
	...
	,
}
...
func (this *Matchers) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*Matchers)
	if !ok {
		that2, ok := that.(Matchers)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *Matchers) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&client.Matchers{")
	if this.Matchers != nil {
		s = append(s, "Matchers: "+fmt.Sprintf("%#v", this.Matchers)+",\n")
	}
	s = append(s, "}")
...
type IngesterClient interface {
	...
	QueryExemplars(ctx context.Context, in *ExemplarQueryRequest, opts ...grpc.CallOption) (*QueryResponse, error)
...
func (c *ingesterClient) QueryExemplars(ctx context.Context, in *ExemplarQueryRequest, opts ...grpc.CallOption) (*QueryResponse, error) {
	out := new(QueryResponse)
...
type IngesterServer interface {
	...
	QueryExemplars(context.Context, *ExemplarQueryRequest) (*QueryResponse, error)
...
func (*UnimplementedIngesterServer) QueryExemplars(ctx context.Context, req *ExemplarQueryRequest) (*QueryResponse, error) {
...
func (m *Matchers) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *Matchers) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Matchers) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (this *Matchers) String() string {
	if this == nil {
		return "nil"
	}
	repeatedStringForMatchers := "[]*LabelMatcher{"
	...
	repeatedStringForMatchers += "}"
	s := strings.Join([]string{`&Matchers{`,
		`Matchers:` + repeatedStringForMatchers + `,`,
		`}`,
	}, "")
	return s
...
func (this *ExemplarQueryRequest) String() string {
	...
	repeatedStringForMatchers := "[]*Matchers{"
	for _, f := range this.Matchers {
		repeatedStringForMatchers += strings.Replace(f.String(), "Matchers", "Matchers", 1) + ","
	}
	repeatedStringForMatchers += "}"
...
func (m *Matchers) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: Matchers: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: Matchers: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
