...
type QueryRequest struct {
	...
	Symbolized       bool            `protobuf:"varint,4,opt,name=Symbolized,proto3" json:"Symbolized,omitempty"`
}
...
func (m *QueryRequest) GetSymbolized() bool {
	if m != nil {
		return m.Symbolized
	}
	return false
...
func (m *QueryStreamResponse) GetSymbols() []string {
	if m != nil {
		return m.Symbols
	}
	return nil
...
type TimeSeriesChunk struct {
	...
	LabelsRefs     []uint32                                                    `protobuf:"varint,5,rep,packed,name=labels_refs,json=labelsRefs,proto3" json:"labels_refs,omitempty"`
}
...
func (m *TimeSeriesChunk) GetLabelsRefs() []uint32 {
	if m != nil {
		return m.LabelsRefs
	}
	return nil
...
var fileDescriptor_60f6df4f3586b478 = []byte{
	...
	,
}
...
func (this *QueryRequest) Equal(that interface{}) bool {
	...
	if this.Symbolized != that1.Symbolized {
		return false
	}
	return true
}
...
func (m *QueryStreamResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Symbols) > 0 {
		for iNdEx := len(m.Symbols) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintIngester(dAtA, i, uint64(len(m.Symbols[iNdEx])))
			i--
			dAtA[i] = 0x1a
		}
	}
...
func (this *QueryRequest) String() string {
	...
	s := strings.Join([]string{`&QueryRequest{`,
		...
		`Symbolized:` + fmt.Sprintf("%v", this.Symbolized) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *QueryRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field Symbolized", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
