...
func newBadgerIndexCache(logger log.Logger, commonMetrics *storecache.CommonMetrics, reg prometheus.Registerer, cfg BadgerIndexCacheConfig) (*BadgerIndexCache, error) {
	badgerOptions := badger.
		DefaultOptions(cfg.DataDir).
