...
type SchedulerToFrontend struct {
	Status SchedulerToFrontendStatus `protobuf:"varint,1,opt,name=status,proto3,enum=frontend2.SchedulerToFrontendStatus" json:"status,omitempty"`
...
func init() {
	proto.RegisterEnum("frontend2.FrontendToSchedulerType", FrontendToSchedulerType_name, FrontendToSchedulerType_value)
	proto.RegisterEnum("frontend2.SchedulerToFrontendStatus", SchedulerToFrontendStatus_name, SchedulerToFrontendStatus_value)
	proto.RegisterType((*QuerierToScheduler)(nil), "frontend2.QuerierToScheduler")
	proto.RegisterType((*SchedulerToQuerier)(nil), "frontend2.SchedulerToQuerier")
	proto.RegisterType((*QueryResultRequest)(nil), "frontend2.QueryResultRequest")
	proto.RegisterType((*QueryResultResponse)(nil), "frontend2.QueryResultResponse")
	proto.RegisterType((*FrontendToScheduler)(nil), "frontend2.FrontendToScheduler")
	proto.RegisterType((*SchedulerToFrontend)(nil), "frontend2.SchedulerToFrontend")
}
...
var fileDescriptor_eca3873955a29cfe = []byte{
	...
	,
}
...
func (this *QuerierToScheduler) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&frontend2.QuerierToScheduler{")
...
func (this *SchedulerToQuerier) GoString() string {
	...
	s := make([]string, 0, 8)
	s = append(s, "&frontend2.SchedulerToQuerier{")
...
func (this *QueryResultRequest) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&frontend2.QueryResultRequest{")
	s = append(s, "QueryID: "+fmt.Sprintf("%#v", this.QueryID)+",\n")
...
func (this *QueryResultResponse) GoString() string {
	...
	s := make([]string, 0, 4)
	s = append(s, "&frontend2.QueryResultResponse{")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *FrontendToScheduler) GoString() string {
	...
	s := make([]string, 0, 9)
	s = append(s, "&frontend2.FrontendToScheduler{")
...
func (this *SchedulerToFrontend) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&frontend2.SchedulerToFrontend{")
...
func (c *schedulerForQuerierClient) QuerierLoop(ctx context.Context, opts ...grpc.CallOption) (SchedulerForQuerier_QuerierLoopClient, error) {
	stream, err := c.cc.NewStream(ctx, &_SchedulerForQuerier_serviceDesc.Streams[0], "/frontend2.SchedulerForQuerier/QuerierLoop", opts...)
	if err != nil {
		return nil, err
	}
...
var _SchedulerForQuerier_serviceDesc = grpc.ServiceDesc{
	ServiceName: "frontend2.SchedulerForQuerier",
...
func (c *frontendForQuerierClient) QueryResult(ctx context.Context, in *QueryResultRequest, opts ...grpc.CallOption) (*QueryResultResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/frontend2.FrontendForQuerier/QueryResult", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _FrontendForQuerier_QueryResult_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/frontend2.FrontendForQuerier/QueryResult",
	}
...
var _FrontendForQuerier_serviceDesc = grpc.ServiceDesc{
	ServiceName: "frontend2.FrontendForQuerier",
...
func (c *schedulerForFrontendClient) FrontendLoop(ctx context.Context, opts ...grpc.CallOption) (SchedulerForFrontend_FrontendLoopClient, error) {
	stream, err := c.cc.NewStream(ctx, &_SchedulerForFrontend_serviceDesc.Streams[0], "/frontend2.SchedulerForFrontend/FrontendLoop", opts...)
	if err != nil {
		return nil, err
	}
...
var _SchedulerForFrontend_serviceDesc = grpc.ServiceDesc{
	ServiceName: "frontend2.SchedulerForFrontend",
...
func (m *SchedulerToQuerier) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.UserID) > 0 {
		...
		i = encodeVarintFrontend(dAtA, i, uint64(len(m.UserID)))
		i--
		dAtA[i] = 0x22
	}
...
func (m *SchedulerToFrontend) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Status != 0 {
		i = encodeVarintFrontend(dAtA, i, uint64(m.Status))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *SchedulerToFrontend) Size() (n int) {
	...
	_ = l
	if m.Status != 0 {
		n += 1 + sovFrontend(uint64(m.Status))
	}
	l = len(m.Error)
	if l > 0 {
		n += 1 + l + sovFrontend(uint64(l))
