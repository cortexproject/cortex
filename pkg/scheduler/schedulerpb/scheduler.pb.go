...
type SchedulerToQuerier struct {
	...
	// Time in nanoseconds the request spent in the scheduler queue.
	QueuedTime int64 `protobuf:"varint,6,opt,name=queuedTime,proto3" json:"queuedTime,omitempty"`
}
...
func (m *SchedulerToQuerier) GetQueuedTime() int64 {
	if m != nil {
		return m.QueuedTime
	}
	return 0
...
var fileDescriptor_2b3fc28395a6d9c5 = []byte{
	...
	,
}
...
func (m *SchedulerToQuerier) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.QueuedTime != 0 {
		i = encodeVarintScheduler(dAtA, i, uint64(m.QueuedTime))
		i--
		dAtA[i] = 0x30
	}
	if m.StatsEnabled {
...
func (m *SchedulerToQuerier) Size() (n int) {
	...
	if m.QueuedTime != 0 {
		n += 1 + sovScheduler(uint64(m.QueuedTime))
	}
	return n
}
...
func (this *SchedulerToQuerier) String() string {
	...
	s := strings.Join([]string{`&SchedulerToQuerier{`,
		...
		`QueuedTime:` + fmt.Sprintf("%v", this.QueuedTime) + `,`,
		`}`,
	}, "")
	return s
}
	...
	for iNdEx < l {
		...
		case 6:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.QueuedTime |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
