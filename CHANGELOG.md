...
* [CHANGE] Metric `cortex_ingester_flush_reasons` has been renamed to `cortex_ingester_series_flush_reasons`, and is now incremented during flush, not when series is enqueued for flushing.
