...
type Stats struct {
	...
	NotOptimizedRegexCount uint64 `protobuf:"varint,15,opt,name=not_optimized_regex_count,json=notOptimizedRegexCount,proto3" json:"not_optimized_regex_count,omitempty"`
}
...
func (m *Stats) GetNotOptimizedRegexCount() uint64 {
	if m != nil {
		return m.NotOptimizedRegexCount
	}
	return 0
}
...
var fileDescriptor_b4756a0aec8b9d44 = []byte{
	...
	,
}
...
func (this *Stats) Equal(that interface{}) bool {
	...
	if this.NotOptimizedRegexCount != that1.NotOptimizedRegexCount {
		return false
	}
	return true
}
...
func (m *Stats) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.NotOptimizedRegexCount != 0 {
		i = encodeVarintStats(dAtA, i, uint64(m.NotOptimizedRegexCount))
		i--
		dAtA[i] = 0x78
	}
	if m.PeakSamples != 0 {
...
func (m *Stats) Size() (n int) {
	...
	if m.NotOptimizedRegexCount != 0 {
		n += 1 + sovStats(uint64(m.NotOptimizedRegexCount))
	}
	return n
}
...
func (this *Stats) String() string {
	...
	s := strings.Join([]string{`&Stats{`,
		...
		`NotOptimizedRegexCount:` + fmt.Sprintf("%v", this.NotOptimizedRegexCount) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *Stats) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 15:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field NotOptimizedRegexCount", wireType)
			}
			m.NotOptimizedRegexCount = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowStats
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.NotOptimizedRegexCount |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
