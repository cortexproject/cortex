...
type Limits struct {
	...
	MaxQueryResponseSize         int            `yaml:"max_query_response_size" json:"max_query_response_size"`
...
func (l *Limits) RegisterFlags(f *flag.FlagSet) {
	...
	f.IntVar(&l.MaxQueryResponseSize, "frontend.max-query-response-size", 0, "The maximum total uncompressed query response size. If the query was sharded the limit is applied to the total response size of all shards. This limit is enforced in query-frontend for `query` and `query_range` APIs. 0 to disable.")
...
func (o *Overrides) MaxQueryResponseSize(userID string) int {
