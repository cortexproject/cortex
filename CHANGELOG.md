...
* [CHANGE] Ingester: Change the HTTP status code 200 to 400 in case the ingester gets the push under the `-blocks-storage.tsdb.enable-native-histograms=false`. #6627
