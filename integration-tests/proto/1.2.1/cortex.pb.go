...
func init() {
	proto.RegisterEnum("cortex.MatchType1.2", MatchType_name, MatchType_value)
	proto.RegisterEnum("cortex.WriteRequest_SourceEnum1.2", WriteRequest_SourceEnum_name, WriteRequest_SourceEnum_value)
	proto.RegisterType((*WriteRequest)(nil), "cortex.WriteRequest1.2")
	proto.RegisterType((*WriteResponse)(nil), "cortex.WriteResponse1.2")
	proto.RegisterType((*ReadRequest)(nil), "cortex.ReadRequest1.2")
	proto.RegisterType((*ReadResponse)(nil), "cortex.ReadResponse1.2")
	proto.RegisterType((*QueryRequest)(nil), "cortex.QueryRequest1.2")
	proto.RegisterType((*QueryResponse)(nil), "cortex.QueryResponse1.2")
	proto.RegisterType((*QueryStreamResponse)(nil), "cortex.QueryStreamResponse1.2")
	proto.RegisterType((*LabelValuesRequest)(nil), "cortex.LabelValuesRequest1.2")
	proto.RegisterType((*LabelValuesResponse)(nil), "cortex.LabelValuesResponse1.2")
	proto.RegisterType((*LabelNamesRequest)(nil), "cortex.LabelNamesRequest1.2")
	proto.RegisterType((*LabelNamesResponse)(nil), "cortex.LabelNamesResponse1.2")
	proto.RegisterType((*UserStatsRequest)(nil), "cortex.UserStatsRequest1.2")
	proto.RegisterType((*UserStatsResponse)(nil), "cortex.UserStatsResponse1.2")
	proto.RegisterType((*UserIDStatsResponse)(nil), "cortex.UserIDStatsResponse1.2")
	proto.RegisterType((*UsersStatsResponse)(nil), "cortex.UsersStatsResponse1.2")
	proto.RegisterType((*MetricsForLabelMatchersRequest)(nil), "cortex.MetricsForLabelMatchersRequest1.2")
	proto.RegisterType((*MetricsForLabelMatchersResponse)(nil), "cortex.MetricsForLabelMatchersResponse1.2")
	proto.RegisterType((*TimeSeriesChunk)(nil), "cortex.TimeSeriesChunk1.2")
	proto.RegisterType((*Chunk)(nil), "cortex.Chunk1.2")
	proto.RegisterType((*TransferChunksResponse)(nil), "cortex.TransferChunksResponse1.2")
	proto.RegisterType((*TimeSeries)(nil), "cortex.TimeSeries1.2")
	proto.RegisterType((*LabelPair)(nil), "cortex.LabelPair1.2")
	proto.RegisterType((*Sample)(nil), "cortex.Sample1.2")
	proto.RegisterType((*LabelMatchers)(nil), "cortex.LabelMatchers1.2")
	proto.RegisterType((*Metric)(nil), "cortex.Metric1.2")
	proto.RegisterType((*LabelMatcher)(nil), "cortex.LabelMatcher1.2")
	proto.RegisterType((*TimeSeriesFile)(nil), "cortex.TimeSeriesFile1.2")
	proto.RegisterType((*TransferTSDBResponse)(nil), "cortex.TransferTSDBResponse1.2")
}
