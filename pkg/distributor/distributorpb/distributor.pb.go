...
var fileDescriptor_c518e33639ca565d = []byte{
	...
	0x09, 0xca, 0x80, 0x68, 0x35, 0xea, 0x64, 0xe4, 0xe2, 0x76, 0x41, 0x58, 0x20, 0x64, 0xc9, 0xc5,
	0x12, 0x50, 0x5a, 0x9c, 0x21, 0x24, 0xa6, 0x07, 0x53, 0xaf, 0x17, 0x5e, 0x94, 0x59, 0x92, 0x1a,
	0x94, 0x5a, 0x58, 0x9a, 0x5a, 0x5c, 0x22, 0x25, 0x8e, 0x21, 0x5e, 0x5c, 0x90, 0x9f, 0x57, 0x9c,
	0xaa, 0xc4, 0x20, 0x64, 0xcf, 0xc5, 0x06, 0xd2, 0x1a, 0x66, 0x24, 0x24, 0x81, 0x5d, 0x73, 0x98,
	0x91, 0x94, 0x24, 0x0e, 0xed, 0x61, 0x46, 0x4a, 0x0c, 0x4e, 0xce, 0x17, 0x1e, 0xca, 0x31, 0xdc,
	...
	0xe5, 0x18, 0xa2, 0x78, 0x91, 0xc2, 0xa7, 0x20, 0x29, 0x89, 0x0d, 0xec, 0x2f, 0x63, 0x40, 0x00,
	0x00, 0x00, 0xff, 0xff, 0xce, 0xdc, 0x64, 0xe8, 0x4a, 0x01, 0x00, 0x00,
}
...
func (c *distributorClient) PushV2(ctx context.Context, in *cortexpb.WriteRequestV2, opts ...grpc.CallOption) (*cortexpb.WriteResponseV2, error) {
...
func (*UnimplementedDistributorServer) PushV2(ctx context.Context, req *cortexpb.WriteRequestV2) (*cortexpb.WriteResponseV2, error) {
...
func _Distributor_PushV2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DistributorServer).PushV2(ctx, req.(*cortexpb.WriteRequestV2))
	}
	return interceptor(ctx, in, info, handler)
}
