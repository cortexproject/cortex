...
func (l *Limits) RegisterFlags(f *flag.FlagSet) {
	...
	f.DurationVar(&l.MaxCacheFreshness, "frontend.per-tenant-max-cache-freshness", 0, "Most recent allowed cacheable result per-tenant, to prevent caching very recent results that might still be in flux.")
