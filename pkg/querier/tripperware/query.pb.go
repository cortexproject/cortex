...
type SampleStream struct {
	...
	RawHistograms []*cortexpb.Histogram `protobuf:"bytes,4,rep,name=rawHistograms,proto3" json:"-"`
}
...
func (m *SampleStream) GetRawHistograms() []*cortexpb.Histogram {
	if m != nil {
		return m.RawHistograms
	}
	return nil
}
...
type Sample struct {
	...
	// This field should be never deserialized into JSON and should only exist in protobuf format.
	RawHistogram *cortexpb.Histogram `protobuf:"bytes,4,opt,name=rawHistogram,proto3" json:"rawHistogram,omitempty"`
}
...
var fileDescriptor_5c6ac9b241082464 = []byte{
	...
	,
}
...
func (this *SampleStream) Equal(that interface{}) bool {
	...
	if len(this.RawHistograms) != len(that1.RawHistograms) {
		return false
	}
	for i := range this.RawHistograms {
		if !this.RawHistograms[i].Equal(that1.RawHistograms[i]) {
			return false
		}
	}
	return true
...
func (this *SampleStream) GoString() string {
	...
	if this.RawHistograms != nil {
		s = append(s, "RawHistograms: "+fmt.Sprintf("%#v", this.RawHistograms)+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *SampleStream) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.RawHistograms) > 0 {
		for iNdEx := len(m.RawHistograms) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.RawHistograms[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (this *SampleStream) String() string {
	...
	for _, f := range this.Histograms {
		repeatedStringForHistograms += strings.Replace(f.String(), "SampleHistogramPair", "SampleHistogramPair", 1) + ","
	}
	repeatedStringForHistograms += "}"
	repeatedStringForRawHistograms := "[]*Histogram{"
	for _, f := range this.RawHistograms {
		repeatedStringForRawHistograms += strings.Replace(fmt.Sprintf("%v", f), "Histogram", "cortexpb.Histogram", 1) + ","
	}
	...
	s := strings.Join([]string{`&SampleStream{`,
		...
		`RawHistograms:` + repeatedStringForRawHistograms + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *SampleStream) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RawHistograms", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RawHistograms = append(m.RawHistograms, &cortexpb.Histogram{})
			if err := m.RawHistograms[len(m.RawHistograms)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
