...
Cortex has an alternative to chunk storage: [block storage](../blocks-storage/_index.md). Block storage is ready for production use and does not require a separate index store.
