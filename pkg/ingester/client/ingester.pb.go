...
func (ReadRequest_ResponseType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_60f6df4f3586b478, []int{0, 0}
}
...
type ChunkedReadResponse struct {
	ChunkedSeries []*TimeSeriesChunk `protobuf:"bytes,1,rep,name=chunked_series,json=chunkedSeries,proto3" json:"chunked_series,omitempty"`
...
func (m *ChunkedReadResponse) GetChunkedSeries() []*TimeSeriesChunk {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*ChunkedReadResponse)(nil), "cortex.ChunkedReadResponse")
...
var fileDescriptor_60f6df4f3586b478 = []byte{
	...
	,
}
...
func (this *ChunkedReadResponse) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&client.ChunkedReadResponse{")
...
func (this *ChunkedReadResponse) String() string {
	if this == nil {
		return "nil"
	}
	repeatedStringForChunkedSeries := "[]*TimeSeriesChunk{"
	for _, f := range this.ChunkedSeries {
		repeatedStringForChunkedSeries += strings.Replace(f.String(), "TimeSeriesChunk", "TimeSeriesChunk", 1) + ","
	}
	repeatedStringForChunkedSeries += "}"
	s := strings.Join([]string{`&ChunkedReadResponse{`,
...
func (m *ChunkedReadResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.ChunkedSeries = append(m.ChunkedSeries, &TimeSeriesChunk{})
