...
* [CHANGE] Alertmanager: Deprecate `cluster.` flags in favor of their `alertmanager.cluster.` equivalent. The deprecated flags (and their respective YAML config options) are: #3677
