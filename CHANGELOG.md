...
* [CHANGE] Ruler: rule groups persisted to object storage using the experimental api have an updated object key encoding to better handle special characters. Rule groups previously stored using object storage must be renamed to the new format. #2646
